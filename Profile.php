  ...
  <body>
    ...
    <div class="maincontainer">
      ...
      <div class="mainfixed">
        <div class="fixed">
          <li>
          <ul class="username"><strong>Username:</strong>
            <br>
            <ul>Hanine Al Khatib</ul>
          </ul>
          <br />

          <ul class="numberoforders"><strong>Number of Orders:</strong>
            <br>
            <ul>17</ul>
          </ul>
          <br />
          <ul class="email"><strong>Email:</strong>
            <br>
            <ul>hanine.alkhatib@gmail.com</ul>
          </ul>
          <br />
          <ul class="email"><strong>Location:</strong>
            <br>
            <ul>Hanine Al Khatib</ul>
          </ul>
          <br /> 
      ...
      <div class="buttons">
          <button class="bmydishes">View My Dishes</button>
          <button class="bmydishes">Edit My Profile</button>
          <button class="bmydishes">View My Orders</button>
        </div>
      </div>
