  ...
  <body class="maincol">
    ...
    <br>
      <div class="rowcontainer">
          ...
          <div class="paraout"> 
              <span class="parain">Find your favorite freshly made dish and order after signing up!</span><div class="Alinks">
      ...
      <div class="rowcontainer" id="2">
          ...
          <div class="paraout"> 
              <span class="parain">Post your own homemade meals!</span><div class="Alinks">
                <?php
      ...
      <div class="maincol" id="3">
        <div class="rowcontainer">
            ...
            <div class="paraout"> 
                <span class="parain">Explore a wide variety of authentic cuisines from around the world</span><div class="Alinks">
                  <?php
                    if (isset($_SESSION['username'])) { 
      ...
      <div class="container card pb-5 pt-4 px-5 pe-0">
        ...
        <div class="row">
          <div class="col">
            ...
            <h6 style="color: #999">by &nbsp;<i class="fa-solid fa-crown" style="color:gold;"></i>&nbsp; <a class="links" href="account.html">Rissal Hedna</a> </h6>
